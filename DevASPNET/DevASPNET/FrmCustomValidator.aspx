<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCustomValidator.aspx.cs" Inherits="DevASPNET.FrmCustomValidator" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
        function FunValidationOddNumber(source, args) {
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:CustomValidator ID="CustomValidator1" runat="server"
                ...
                ClientValidationFunction="FunValidationOddNumber"></asp:CustomValidator>
            <hr />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmInputControl.aspx.cs" Inherits="DevASPNET.FrmInputControl" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width: 500px">
                <tr>
                    <td style="width: 200px">채크박스(이용약관):</td>
                ...
                <tr>
                    ...
                    <td style="width: 100px">
                        <asp:CheckBoxList ID="lstHobby" runat="server"
                            ...
                            <asp:ListItem Selected="True" Value="B"></asp:ListItem>
                        </asp:CheckBoxList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width: 200px; height: 24px">드롭다운리스트(단일 선택)</td>
                    <td style="width: 100px; height: 24px">
                        <asp:DropDownList ID="lstJob" runat="server">
                            <asp:ListItem>회사원</asp:ListItem>
                            <asp:ListItem Selected>공무원</asp:ListItem>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmPanel.aspx.cs" Inherits="DevASPNET.FrmPanel" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="pnlSecond" runat="server"
                Height="50px" Width="200px" GroupingText="그룹상자">
                반갑습니다.<br />
            </asp:Panel>
            <br />
            <hr />
            ...
            <asp:Panel ID="pnlCommand" runat="server"
                ...
                <asp:Button ID="btnShowPanel1" runat="server"
                    Text="첫 번쨰 패널 보이기" OnClick="btnShowPanel1_Click" />

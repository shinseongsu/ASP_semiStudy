<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCommandControl.aspx.cs" Inherits="DevASPNET.FrmCommandControl" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:LinkButton ID="btnLink" runat="server"
                Onclick="btnCommand_Click">링크 버튼</asp:LinkButton><br />
            <br />
            이미지버튼 컨트롤 :
